...
class Config:
    ...
    def parse_training_config(self, json_data):
        ...
        self.head_lr_factor = train.get("HeadLrFactor", 0.5)
        self.noreg_lr_factor = train.get("NoregLrFactor", 1.0)
        self.muon_adam_lr_factor = train.get("MuonAdamLrFactor", 1.0)
        self.input_wd_factor = train.get("InputWdFactor", 1.0)
        self.normal_wd_factor = train.get("NormalWdFactor", 1.0)
        self.normal_attn_wd_factor = train.get("NormalAttnWdFactor", 1.0)
        ...
        self.wd_floor_frac = train.get("WdFloorFraction", None)
    ...
    def parse_nn_config(self, json_data):
        ...
        self.ffn_expansion_ratio = network.get("FFNExpansionRatio", 1.5)
        self.transformer_drop_rate = network.get("TransformerDropRate", 0.0)
        ...
        self.attention_qk_norm = network.get("AttentionQKNorm", True)
