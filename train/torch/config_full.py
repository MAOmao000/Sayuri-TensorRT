...
class Config:
    ...
    def parse_nn_config(self, json_data):
        ...
        self.gab_num_templates = network.get("GABNumTemplates", 32)
        self.gab_num_fourier_features = network.get("GABNumFourierFeatures", 12)
        self.gab_mlp_hidden = network.get("GABMLPHidden", 96)
